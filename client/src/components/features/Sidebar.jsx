    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open} >
        ...
        <List>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/Graduates")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              >
                ...
                <ListItemText primary="Graduates" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/Post")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/SignInSide")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
