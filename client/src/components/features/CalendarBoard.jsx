...
const EventCalendar = () => {
  ...
  const handleOpenModal = (event, date) => {
    setShowModal(true);
    setEditingEvent(
      event ? { ...event } : { start: date, end: date, allDay: true }
    );
  };
            ...
            <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditingEvent({
                      ...
                      start: new Date(
                        `${e.target.value}T${
                          editingEvent?.start.toISOString().split("T")[1]
                        }`
                      ),
                    })
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditingEvent({
                      ...editingEvent,
                      start: new Date(
                        `${editingEvent?.start.toISOString().split("T")[0]}T${
                          e.target.value
                        }`
                      ),
                    })
              ...
              <label>
                  ...
                  onChange={(e) =>
                    setEditingEvent({
                      ...editingEvent,
                        ...
                        `${e.target.value}T${
                          editingEvent?.end.toISOString().split("T")[1]
                        }`
                      ),
                    })
                  }
                ...
                <input
                  ...
                  name="endTime"
                  value={
                    editingEvent?.end.toISOString().split("T")[1].slice(0, 5) ||
                    ""
                  }
                  onChange={(e) =>
                    setEditingEvent({
                      ...editingEvent,
                        ...
                        `${editingEvent?.end.toISOString().split("T")[0]}T${
                          e.target.value
                        }`
                      ),
                    })
